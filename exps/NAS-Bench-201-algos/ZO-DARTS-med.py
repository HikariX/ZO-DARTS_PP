...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_path", type=str, default="../../nasbench201/dataset/organamnist.npz", help="The path to dataset")
    parser.add_argument(
        "--dataset",
        type=str,
    ...
    parser.add_argument(
        "--save_dir", type=str, default="ZO-DARTS_med+2", help="Folder to save checkpoints and log."
    )
    parser.add_argument(
        "--arch_nas_dataset",
        type=str,
